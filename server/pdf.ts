...
function generateMarkdown(lang: "sv" | "en", points: PolicyPoint[]): string {
  ...
  // About section
  md += isSv ? `## Om det här projektet\n\n` : `## About this project\n\n`;

  md += isSv
    ? `Det hela började med en post på Facebook av Troed Troedson. Han utmanade: "Riksdagspartier! Håll varsin presskonferens med 15 punkter som underlättar människors resa i stället för det motsatta. Men håll en workshop först så det inte blir så där taffligt som det gärna blir annars."\n\nSagt och gjort. Jag workshoppade med mitt team och kom fram till 15 punkter som är, så klart, väldigt mycket mina. Lutar mig tungt på internet, digitalisering generellt och AI i synnerhet. Och som lika självklart är work in progress. Better together, som vanligt.\n\n`
  ...
  md += isSv
    ? `Läs mer: [Hela vår beskrivning av hur man gör sånt här 2026](https://ai.jardenberg.se/15p-build)\n\n`
    : `Read more: [Our full write-up on how you build something like this in 2026](https://ai.jardenberg.se/15p-build)\n\n`;
